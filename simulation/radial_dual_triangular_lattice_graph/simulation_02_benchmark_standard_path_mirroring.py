...
# Computes shortest paths from a random outer start, then recomputes equivalent in inner from inverted start.
def benchmark_standard_path_mirroring(G_outer, G_inner, start_outer, inversion_map, runs, timing_repeats):
...
if __name__ == "__main__":
    ...
    G_outer, G_inner, inversion_map = build_radial_dual_triangular_lattice_graph(args.R)  # Build graphs
    ...
    avg, std = benchmark_standard_path_mirroring(G_outer, G_inner, start_outer, inversion_map, args.runs, args.timing_repeats)
