...
for _ in range(num_trials):
    ...
    # Compute weights: w_i = y_i^2 / sigma^2 (Section 6)
    weights_awgn = y_awgn**2 / (sigma**2)
    weights_impulsive = y_impulsive**2 / (sigma**2)
...
ber_correction_awgn = errors_correction_awgn / num_trials * 100  # Approx. 0.000%
ber_correction_impulsive = errors_correction_impulsive / num_trials * 100  # Approx. 12.8%
print(f"Script 3 - Soft-Decision: Correction AWGN BER = {ber_correction_awgn:.3f}%, "
